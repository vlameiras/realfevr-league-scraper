...
TEAMS_URL = '/teams/{}'
LOGIN_URL = '/users/sign_in?utf8=%E2%9C%93&authenticity_token=<placeholder>%3D&user%5Bemail%5D={}&user%5Bremember_me%5D=0&user%5Bpassword%5D={}&button='.format(REALFEVR_USERNAME, REALFEVR_PASSWORD) # pylint: disable=line-too-long
LEAGUE_IDS = []
